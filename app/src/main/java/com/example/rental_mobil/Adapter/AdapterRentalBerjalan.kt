...
import com.example.rental_mobil.Admin.RentalBerjalanActivity
import com.example.rental_mobil.Admin.RentalDetailActivity
import com.example.rental_mobil.R

class AdapterRentalBerjalan (val dataRental: List<HashMap<String,String>>, val parent: RentalBerjalanActivity) :
    RecyclerView.Adapter<AdapterRentalBerjalan.HolderDataRental>(){
